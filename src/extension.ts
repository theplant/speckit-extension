...
export function activate(context: vscode.ExtensionContext) {
  ...
  // Create tree view for activity bar container
  const treeView = vscode.window.createTreeView('speckit.specsView', {
    treeDataProvider: treeProvider,
    showCollapseAll: true
  });

  // Create tree view for Explorer sidebar
  const treeViewExplorer = vscode.window.createTreeView('speckit.specsViewExplorer', {
    treeDataProvider: treeProvider,
    showCollapseAll: true
  });
